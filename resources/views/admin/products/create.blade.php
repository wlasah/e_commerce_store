                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" name="image" id="image" accept="image/*"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        <p class="text-gray-500 text-xs mt-1">Optional. Maximum file size: 2MB</p>
                        @error('image')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="mt-1 flex items-center">
                            ...
                            <p class="ml-4 text-sm text-gray-500">Image preview will appear here after selection</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById('image').addEventListener('change', function(event) {
            ...
            if (event.target.files && event.target.files[0]) {
                ...
                output.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>';
            }
        });
    </script>
@endsection